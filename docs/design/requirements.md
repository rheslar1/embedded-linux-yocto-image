# Embedded Linux / Yocto Image Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for Embedded Linux / Yocto Image. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Custom Linux image for Raspberry Pi, BeagleBone, or i.MX-class hardware with Yocto recipes, kernel config, service units, and rootfs notes. | Scenario tests and documentation review. |
