...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Embedded Linux / Yocto Image. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Custom Linux image for Raspberry Pi, BeagleBone, or i.MX-class hardware with Yocto recipes, kernel config, service units, and rootfs notes. | Scenario tests and documentation review. |
