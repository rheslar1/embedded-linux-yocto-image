# Embedded Linux / Yocto Image Deep Architecture
...
C++17, C++ Design Patterns, SOLID, Yocto, BitBake, Kernel config, Systemd, Device tree, Rootfs, BEMS
...
- Source boundary: `include, src, yocto`
- Executable entry: `src/main.cpp`
- Test coverage: `tests/YoctoImageTests.cpp`
